 ...
 * @author Andrew
 */
public class SpecialsPrompt extends javax.swing.JFrame {
    ...
    public final void getRecipeName() {
        ...
        for (int i = 0; i < n; i++) {
            jComboBox1.addItem((String) newManager.getRecipeData()[i][1]);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Discount Price");
        ...
        jLabel3.setText("Specials Setup");
